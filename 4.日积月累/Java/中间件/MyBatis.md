...
![9c1-01](../../../assets/9c1-01.png)

创建模版文件：

![9c1-02](../../../assets/9c1-02.png)

创建文件选择使用的模版：

![9c1-03](../../../assets/9c1-03.png)
...
2. 在文件中，使用 key=value的格式定义数据。例如 jdbc.url=jdbc:mysq://localhost:3306/springdb
